-- Fix the create_conversation_rpc function to prevent duplicate participant inserts
-- The issue is that both the RPC and the trigger try to add participants
